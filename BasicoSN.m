...
Hu_ord1 = [Hu0(1,:); Hu1(1,:); Hu2(1,:); Hu3(1,:); Hu4(1,:);...
           Hu5(1,:); Hu6(1,:); Hu7(1,:); Hu8(1,:); Hu9(1,:)];

Hu_ord2 = [Hu0(2,:); Hu1(2,:); Hu2(2,:); Hu3(2,:); Hu4(2,:);...
           Hu5(2,:); Hu6(2,:); Hu7(2,:); Hu8(2,:); Hu9(2,:)].*10;

Hu_ord3 = [Hu0(3,:); Hu1(3,:); Hu2(3,:); Hu3(3,:); Hu4(3,:);...
           Hu5(3,:); Hu6(3,:); Hu7(3,:); Hu8(3,:); Hu9(3,:)].*100;

Hu_ord4 = [Hu0(4,:); Hu1(4,:); Hu2(4,:); Hu3(4,:); Hu4(4,:);...
           Hu5(4,:); Hu6(4,:); Hu7(4,:); Hu8(4,:); Hu9(4,:)].*100;
...
dists = [sqrt(sum((X-z0).^2));...
 ...
 hold on
 for i = 1:length(I)
     text(i*60,0,int2str(I(i)-1),'FontSize',14,'Color','cyan');
 end
 hold off